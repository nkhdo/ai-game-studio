...
<template>
  <section class="card movement-step accordion-item" :class="{ 'is-open': studio.activeStep === 'frames' }">
    <button class="accordion-trigger" type="button" :aria-expanded="studio.activeStep === 'frames'" @click="studio.actions.setStep('frames')"><span>3. Generate Frames</span><span class="accordion-trigger__icon" /></button>
