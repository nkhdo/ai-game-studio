...
<template>
  <section class="card movement-step accordion-item" :class="{ 'is-open': studio.activePanel === 'movement' }">
    ...
    <div class="panel-body">
      ...
      <BaseButton variant="primary" block :busy="operation.phase === 'running'" :disabled="!studio.hasApiKey || !studio.state.project?.spriteUrl" @click="studio.actions.generateVideo">Generate Video</BaseButton>
